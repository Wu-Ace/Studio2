...
public class UnityRemoteTestScript : MonoBehaviour
{
    ...
    private void UpdateTouch()
    {
        ...
        if (touchscreen.primaryTouch.isInProgress)
        {
            ...
            //     main_camera.ScreenToWorldPoint(new Vector3(touchPosition.x, touchPosition.y, transform.position.z + m_CubeOffsetFromCanvas));        rotatingCube.position = worldSpacePosition;
        }
    }
